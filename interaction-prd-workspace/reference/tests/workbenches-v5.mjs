...
console.log('PASS: legacy specs inherited on workspace entry; TXT one-card/full text/archive/invalid input; script QC before aspect; multi-line QC IDs/schema/atomic repair; video model snapshot; per-line TTS and stale voice; sequential dependencies; project isolation.');
